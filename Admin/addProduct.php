...
<?php 
	...
	if(isset($_POST['submit'])){
		...
		$insert=mysqli_query($connect,"insert into products(productName, price, user_id , description, category, image, pincode, seller , brand, storage, ram, size, processor) values('$name','$price','$_SESSION[id]','$description','$category','$image_name','$pincode','$seller', '$brand','$storage','$ram','$size','$processor')");
		if($insert){
